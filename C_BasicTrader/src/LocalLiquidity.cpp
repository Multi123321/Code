...
LocalLiquidity::LocalLiquidity(double deltaArg, double deltaUpArg, double deltaDownArg, double dStarArg, double alphaArg) : deltaUp(deltaUpArg), deltaDown(deltaDownArg), delta(deltaArg), dStar(dStarArg), alpha(alphaArg)
{
    type = -1;
    initalized = false;
...
LocalLiquidity::LocalLiquidity(double deltaArg, double deltaUpArg, double deltaDownArg, PriceFeedData::Price priceArg, double dStarArg, double alphaArg) : deltaUp(deltaUpArg), deltaDown(deltaDownArg), delta(deltaArg), dStar(dStarArg), alpha(alphaArg)
{
    type = -1;
