...
{
    ofstream outputFile;
    functions::openOutputFile(outputFile, configValues["outputDir"], "DataAsymmLiq.csv");
...
{
    ofstream outputFile;
    functions::openOutputFile(outputFile, configValues["outputDir"], "DataAsymmLiq.csv", ofstream::app);
